...
# basic_model = models.buildin_models("ResNet101V2", dropout=0.4, emb_shape=512, output_layer="E")
    basic_model = models.buildin_models("r100", dropout=0.4, emb_shape=512, output_layer="E",  activation='prelu', use_se=True)
    data_path = '../Datasets/faces_emore_112x112_folders'
    eval_paths = ['../Datasets/faces_emore/lfw.bin', '../Datasets/faces_emore/cfp_fp.bin', '../Datasets/faces_emore/agedb_30.bin']
    save_path = 'r100seprelu_emore.h5'
...
#    optimizer = tf.keras.optimizers.SGD(lr=0.1, momentum=0.9, decay=5e-4)
    sch = [
        {"loss": losses.ArcfaceLoss(), "epoch": 16, "optimizer": optimizer},
